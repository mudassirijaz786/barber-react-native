...
export default class Profile extends React.Component {
  ...
  async logout() {
    ...
    await AsyncStorage.removeItem("x-auth-token")
      .then((res) => console.log("removed successfullly", res))
      .catch((err) => console.log("not remove", err));
      ...
      <Block flex style={styles.profile}>
        <Block flex>
          <ImageBackground
            source={{
              uri:
                "https://i.pinimg.com/236x/7f/79/6d/7f796d57218d9cd81a92d9e6e8e51ce4--free-avatars-online-profile.jpg",
            }}
        ...
        <Block flex style={styles.options}>
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <Block style={{ paddingBottom: -HeaderHeight * 2 }}>
              <Button
                onPress={() =>
                  this.props.navigation.navigate("SignIn") && this.logout
                }
              >
                Logout
              </Button>
